...
export const revengSlides: Slide[] = [
  ...
  },
  {
    ...
    body: "Terzo e ultimo livello: XOR. Immagina di prendere ogni lettera del messaggio e di «mescolarla» con un numero segreto, che si chiama chiave. Il risultato è una fila di simboli senza senso, che sembra rumore casuale. Perché è debole? Perché la mescolanza si può annullare: se applichi di nuovo la stessa chiave al testo mescolato, il messaggio torna in chiaro, esattamente com'era prima. E in questo caso la chiave è un solo numero, che va da 1 a 255: le possibilità sono poche, quindi si possono provare tutte, una alla volta, finché non appare il testo leggibile. Nel task lo farai tu: muovi uno slider e guardi il testo apparire appena arrivi al numero giusto.",
